...
class PizzaDelivery:
    ...
    def make_order(self):
        self.ordered = True
        return f"You've ordered pizza {self.name} prepared with {self.get_all_ingredients(self.ingredients)} and the price will be {self.price}lv."

    def get_all_ingredients(self, ingredients: dict):
        tmp = []
